...
public:
	...
	*/
	template<class STLContainer>
	int Split( STLContainer& PartList, const CNxNString& Separators ) const
	{
...
/*! \fn inline CNxNString operator + (const CNxNString& s1, const CNxNString& s2)
	\param	s1 first part of result string
	\param	s2 second part of result string
	\return	 CNxNString object with complete string
...
/*! \fn inline CNxNString operator + (LPCSTR psz, const CNxNString& s)
...
/*! \fn inline CNxNString operator + (LPCWSTR psz, const CNxNString& s)
	\param	psz first part of result string
	\param	s second part of result string
	\return	 CNxNString object with complete string
	<dl compact><dt><b>Comments</b>
...
/*! \fn inline CNxNString operator + (wchar_t c, const CNxNString& s)
...
*/
inline CNxNString operator + (wchar_t c, const CNxNString& s)
{
	return CNxNString(c)+=s;
}
/*! \fn inline CNxNString operator + (char c, const CNxNString& s)
	\param	c first part of result string
	\param	s second part of result string
	\return	 CNxNString object with complete string
	<dl compact><dt><b>Comments</b>
...
*/
inline CNxNString operator + (char c, const CNxNString& s)
{
	return CNxNString(c)+=s;
}
/*! \fn inline CNxNString operator + (const CNxNString& s, LPCSTR psz)
...
/*! \fn inline CNxNString operator + (const CNxNString& s, LPCWSTR psz)
	\param	s first part of result string
...
/*! \fn inline CNxNString operator + (const CNxNString& s, wchar_t c)
	\param	s first part of result string
...
*/
inline CNxNString operator + (const CNxNString& s, wchar_t c)
{
	return CNxNString(s)+=c;
}
/*! \fn inline CNxNString operator + (const CNxNString& s, char c)
	\param	s first part of result string
	\param	c second part of result string
	\return	 CNxNString object with complete string
	<dl compact><dt><b>Comments</b>
...
*/
inline CNxNString operator + (const CNxNString& s, char c)
{
	return CNxNString(s)+=c;
}
