...
class NXNINTEGRATORSDK_API CNxNBrowseFilter : public CNxNObject {
	public:
		 ...
		 *	
		 *	\return		boolean expression indicating the command was successfully added to the internal list.
		 *	
		 *	\note		
		 */
		 ...
		 *	\param		strPath is a NamespaceType or NamespacePath.
		 *	
		 *	\return		boolean expression indicating if the command could be successfully added
		...
		/*!	\fn			inline bool CNxNBrowseFilter::TrackGlobalSelection(const CNxNString& strPath = _STR("\\"))
		 *	
		 *				User wants this control to track only its own local selection! This turns
		 ...
		 *				in the list view.
		 *	
		 *	\param		strPath is a NamespaceType.
		 *	
		 *	\return		boolean expression indicating if the command could be successfully added
		 *				to the internal list.
		 *	
		 ...
		 *	
		 *				User specifies a selection tracking formula. This formula can be generated from
		 *				the global selection path. Such a formula can look like this:<br>
		 ...
		 *				control.
		 *	
		 *	\param		strPath is a NamespacePath or selection tracking formula.
		 *	
		 *	\return		boolean expression indicating if the command could be successfully added
		 *				to the internal list.
		 *	
		 ...
		 *				All parent objects above this node are invisible afterwards.
		 *	
		 ...
		 *	\param		strPath is a NamespaceType or NamespacePath.
		 *	
		 *	\return		boolean expression indicating if the command was successfully added to the internal list. 
		 *	
		 *	\note		
		 */
		 ...
		 *	\param		strPath is a NamespaceType or NamespacePath.
		 *	
		 *	\return		boolean expression indicating if the command could be successfully added to the internal list.
		 *	
		 *	\note		
		 */
		 ...
		 *				An external client can now take over to process the double click.  
